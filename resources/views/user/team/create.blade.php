...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Create New Team Member') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('user.team.create') }}">{{ __('Create New Team Member') }}</a></li>
		...
		<div class="col-xl-12 col-lg-12 col-sm-12">
			<div class="card border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Create New Team Member') }}</h3>
				</div>
					...
					<form method="POST" action="{{ route('user.team.store') }}" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-sm-6 col-md-6">
								<div class="input-box">
									<div class="form-group">
										<label class="form-label fs-12">{{ __('Full Name') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></label>
							...
							<div class="col-sm-6 col-md-6">
								<div class="input-box">
									<div class="form-group">
										<label class="form-label fs-12">{{ __('Email Address') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></label>
							...
							<div class="col-sm-6 col-md-6">
								<div class="input-box">
									<div class="form-group">
										<label class="form-label fs-12">{{ __('New Password') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></label>
							...
							<div class="col-sm-6 col-md-6">
								<div class="input-box">
									<div class="form-group">
										<label class="form-label fs-12">{{ __('Confirm New Password') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></label>
